...
import {
  DiscountBadge,
  IDiscountBadgeProps
} from "../DiscountBadge/DiscountBadge.bundle";
// Button
...
export const Snippet: FC<ISnippetProps> = ({
  ...
  const soldOutSrc =
    "//yastatic.net/market-export/_/i/marketplace/sold-out.svg";
    ...
    >
      ...
      >
        ...
        <div className={cnSnippet("Info")}>
          {showPrice ? (
            <div
              className={cnSnippet("Price")}
              style={{ order: getFoundIndex<TOrder>("price", orders) }}
            >
              <Price
                price={price}
                oldPrice={oldPrice}
                size={config.price.size}
              />
            </div>
          ) : null}
          {showRating ? (
            <div
              className={cnSnippet("Rating")}
              style={{ order: getFoundIndex<TOrder>("rating", orders) }}
            >
              <Rating
                type="extended"
                value={rating}
          ...
          {showTitle ? (
            <div
              className={cnSnippet("Title")}
              style={{ order: getFoundIndex<TOrder>("title", orders) }}
            >
