...
import { withKnobs, array, boolean, color, number, select, text } from '@storybook/addon-knobs';
...
export const Playground = () => {
    ...
    const separatorMode = select('Separator mode', {
    ...
    const Link: React.FC = ({ children }) => {
        return <a href="https://yandex.ru" target="_blank">{children}</a>;
    };
