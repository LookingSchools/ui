...
import {
  ColorBoxRadio as Radio,
  IColorBoxRadioProps
} from "./Radio/ColorBox-Radio";
...
export const ColorBox = class extends Component<ColorBoxProps> {
  ...
  render() {
    ...
    return (
      <div
        {...props}
        className={cnColorBox(null, [className])}
        ref={this.innerRef}
        role="radiogroup"
      >
        <fieldset>
            ...
            {colors
              .map((color, index) => {
                ...
                return {
                  ...
                  "aria-labelledby": `label-${index}-${this.generateUniqID(
                    index
                  )}`
                };
              })
