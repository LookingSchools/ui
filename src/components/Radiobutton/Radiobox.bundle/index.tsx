...
import { IRadiobuttonProps as IRadiobuttonBaseProps, Radiobutton as RadiobuttonBase } from '../Radiobutton';
// _size
...
export const Radiobutton = compose(composeU(withSizeM, withSizeS), composeU(withThemeDefault))(RadiobuttonBase) as FC<
    IRadiobuttonProps
>;
