...
storiesOf("Takberi/Components|Image/", module)
  .addDecorator(withKnobs)
  .addDecorator(
    withDocs({
      readme: {
        content: require("./Image.md").default
      }
    })
  )
  .add("playground", () => {
  ...
  .add("sizes and srcSet", () => (
    <>
      <p>
        Чтобы увидеть разницу, измените ширину окна браузера во вкладке{" "}
